...
def store_Job_description(Job_Role, Required_Programming_Skills, Required_Soft_Skills, Required_Technical_Skills, Required_Years_of_Experience, Required_Educational_Qualifications):
    try:
        ...
        CREATE TABLE Job_Descriptions (
            ...
            Required_Years_of_Experience VARCHAR(255),
        ...
        (Job_Role, Required_Programming_Skills, Required_Soft_Skills, Required_Technical_Skills, Required_Years_of_Experience, Required_Educational_Qualifications)
        VALUES (?, ?, ?, ?, ?, ?)
        """
